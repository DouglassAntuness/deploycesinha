$.templateCustomizador = [
	{
		popup: "<div class='popup card col s12 no-margin-tb no-padding'>" +
		...
		" </div>" +
		" </div>" +
		" <div class='card-content no-borderelms' tabindex='0'>" +
		" </div>" +
		" </div> ",
		...
		botao: "<a id='botao'  class='waves-effect waves-light btn' >" +
		"<span id='botao'  > button </span>" +
		"</a>",
		selectbox: "<teste id='selectbox' data-tela='true' > </teste>",
		tabela: "<table id='tabela'  class='table-move striped'> <thead> " +
		"<tr> <th id='thSelecionar' style='max-width: 25px; width: 25px'> </th> </tr> </thead> <tbody> <tr> <td style='width: 25px; max-width: 25px;'> <input id='selecionarLinha' type='checkbox'> </td> </tr> </tbody> </table>",
		...
		link: "<a id='link' href='#'  class='cursor-pointer'> Link </a>",
		imagem: "<img id='imagem' src='default.png' style='width: 100px; height: 100px;' /> ",
		grafico: "<canvas id='grafico' width='400' height='400' style='width: 100%; height: 100%;' ></canvas>",
...
$.template = [
	{
		...
		"<div class='card-title'> </div> <div class='card-icone'> <i class='fa fa-question-circle' onclick='g$.popHelp()'>  </i>" +
		" <i class='fa fa-close' onclick='g$.popClose()'>  </i>" +
		...
		graficoTorre: "<canvas id='graficoTorre' height='235' width='509' style='width: 509px; height: 235px;'></canvas>",
		menu_bloco: "<div class='col l3 m4 s6'> <div id='menu-bloco' class='animated bounceInUp'> <i id='icone_menu'> </i> " +
...
$.combo = [
	{
		...
		"<option value=''> </option>" +
		"<option value='DD_MM_YYYY'> DD_MM_YYYY </option>" +
